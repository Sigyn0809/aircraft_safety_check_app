        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              left: MediaQuery.of(context).size.width * 0.5 - screenWidth * 0.67 / 2, // 수평 중앙 정렬
              child: Column(
            ...
            // 클릭 버튼
            Positioned(
              top: screenHeight * 0.75, // 클릭 버튼의 상단 위치
              left: MediaQuery.of(context).size.width * 0.5 - 150 / 2, // 수평 중앙 정렬
              child: Container(
                width: 150,
